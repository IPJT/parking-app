...
export type VehicleCard_VehicleFragmentFragment = { __typename?: 'Vehicle', id: string, name: string, brand: string, accessTokensReponse: any, vin: string } & { ' $fragmentName'?: 'VehicleCard_VehicleFragmentFragment' };
